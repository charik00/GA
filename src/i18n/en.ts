...
export const en = {
  ...
  'hero.sub': 'Whole plants. Whole intelligence.',
  ...
  'forwhom.title.a': 'For those who refuse',
  'forwhom.title.b': 'temporary solutions.',
  'forwhom.body1':
    'Most supplements deliver isolated ingredients. We preserve complete botanical intelligence. Because healing begins with complexity, not simplification.',

  'phil.num': '— 02 / The Philosophy',
  'phil.title.a': 'Why modern supplementation',
  'phil.title.b': 'often falls short.',
  'phil.c1.n': '01 / Cause',
  'phil.c1.t': 'Symptoms are consequences.',
  'phil.c1.b':
    'A laboratory value can improve while the underlying biology remains unchanged.',
  'phil.c2.n': '02 / System',
  'phil.c2.t': 'The body understands complexity.',
  'phil.c2.b': 'Every organ influences another. Every pathway depends on the next.',
  'phil.c3.n': '03 / Formula',
  'phil.c3.t': 'Nature is more than chemistry.',
  'phil.c3.b':
    'Nature never created isolated ingredients. Only complete biological systems.',
  ...
  'cta.title.a': "Let's",
  'cta.title.b': 'begin.',
  'cta.sub': 'Every person has a different story. Every formula begins by understanding it.',
  'cta.b1': 'Start the conversation',
  'cta.b2': 'Explore Products',
